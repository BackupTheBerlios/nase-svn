...
Pro WIC_MyWidget_handler, event
...
Function widget_image_container::init, _REF_EXTRA=_ref_extra
   ...
   If not Init_Superclasses(self, "widget_image_container", _EXTRA=_ref_extra) then return, 0
   ...
   ;; add showit to present picture
    self.showit_id = widget_showit(self.widget, /Private_Colors, $
                                   UValue=self, $
                                   Notify_Realize="WIC_Notify_realize")
