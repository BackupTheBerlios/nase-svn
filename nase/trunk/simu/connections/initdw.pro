...
;
; AIM:
;  Init and define a connection matrix (SDW struct).
;
; PURPOSE: 
;  Create a connection matrix that will be used by the <A>DelayWeigh</A>
...
;
; OPTIONAL INPUTS::
;  SOURCE_TO_TARGET  :: Dies ist der Default: Die folgenden Verbindungs- und Delay-Schlüsselworte
...
;*My_DWS = InitDW (S_Layer=My_Layer, T_Layer=My_Layer, W_GAUSS=[1,4], /W_NONSELF)
;
; complete example:
