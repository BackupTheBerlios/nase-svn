...
;    Results can be directed to  output variables
;    See notes below for comparison with the intrinsic IDL function <*>PCOMP</*>.<BR>
;    This routine was carried out from <I>Institut fuer Astronomie und Astrophysik</I>
;    Universitaet Tuebingen (http://astro.uni-tuebingen.de/software/idl).
;    
;
; CATEGORY:
;  Signals
;
; CALLING SEQUENCE:
;*PCA, data, eigenval, eigenvect, percentages, proj_obj, proj_atr [,MATRIX=MATRIX] [, /COVARIANCE][, /SSQ][, /SILENT ]
;
; INPUTS:
...
;                   is set, the <I>sum of squares and cross-products</I> matrix if
...
;      Transform) according to the method described in <I>Multivariate Data 
;      Analysis</I> by Murtagh & Heck [Reidel : Dordrecht 1987], pp. 33-48. 
;
...
;         returns the variance in each variable<BR>  
;
; EXAMPLE:
...
;     
;        Pleas note that data can recovered exactly by 
;
;*       data = (transpose(eigenvect)#proj_obj)
;
;
;-
