...
;
; CALLING SEQUENCE:
;* esignal = Envelope(signal, fS  [, FLOW=...] [, FHIGH=...] [, WLOW=...] [, WHIGH=...] [, /ABSOLUTEWIDTHS] [, ATTENUATION=...]
;*                             |  [, FILTER=...]
;
; INPUTS:
...
;* Plot , FilteringFFT(Signal, 500, FLOW = 50, FHIGH = 60, WLOW = 3, WHIGH = 3, /ABSOLUTEWIDTHS)
;* OPlot, Envelope(    Signal, 500, FLOW = 50, FHIGH = 60, WLOW = 3, WHIGH = 3, /ABSOLUTEWIDTHS), color = RGB('red')
;
; SEE ALSO:
