...
;
; AIM:
;   derives unfiltered LFP signals from membrane potentials
;
; PURPOSE:
;   Computes LFP-signals similar to those got by
;   micro-electrode recordings. You can choose
;   various recording positions. The signals are
;   generated by collecting membrane potentials
;   for the neuron's neighbors with spatially
...
;
; CALLING SEQUENCE:
;   LFPS = LFP( mt, recSites { ,HMW_EXP=... | ,HMW_GAUSS=... } [,ROI=...] [,/NASE] )
;
; INPUTS: 
;   mt:: 3d-array, containing the temporal
...
;   WRAP::      LFP is generated using toroidal
;               boundary conditions 
;                       
; OPTIONAL OUTPUTS:
...
;
; OUTPUTS:
;   LFPS:: array (index, time) containing the lfp signals
;
; EXAMPLE:
