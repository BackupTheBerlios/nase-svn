...
;  available. <C>TryReadu()</C> attempts to read from a file, but will
...
;  correctly on your system, use <C>TryReadu()</C> instead.</I><BR>
;  Note: since Rev. 1.4, <C>TryReadu()</C> calls <A>Available()</A>
...
;
; CALLING SEQUENCE:
;*result = TryReadu( lun, var1,...,varn [,/VERBOSE] [,KEYWORDS] )
;
; INPUTS:
;  lun, var1,...,varn:: These arguments are identical to those of
;                       IDL's <C>READU</C> command. Please see the IDL
;                       help for documentation.
;
; INPUT KEYWORDS:
;  VERBOSE :: If this keyword is set, <C>TryReadu</C> will issue debug
;             messages via <A>DMsg</A>, specifying the reason for a
;             failed read-attempt.
;  KEYWORDS:: Any other keywords given are passed by value to IDL's
;             <C>READU</C> command. Please see the IDL help for
;             documentation.
;
; OUTPUTS:
...
;
; PROCEDURE:
;  Call <A>Available</A>, if true, <C>READU</C>.
;
; EXAMPLE:
;*$mkfifo testfifo
...
;*printf,23,"line3"
;*l=""
;*while TryReadu(24,l,/verbose) do print,l
;*>line1
;*>line2
;*>line3
;
...
;  <C>ON_IOERROR</C>, <C>READU</C>.
;-

Function TryReadu, lun, var2, var3, var4, var5, var6, var7, var8, $
                   verbose=verbose, $
                   _extra=_extra
...
;   case n_params() of
;      1: Readu, lun, _extra=_extra 
;      2: Readu, lun, var2, _extra=_extra
;      3: Readu, lun, var2, var3, _extra=_extra
;      4: Readu, lun, var2, var3, var4, _extra=_extra
;      5: Readu, lun, var2, var3, var4, var5, _extra=_extra
;      6: Readu, lun, var2, var3, var4, var5, var6, _extra=_extra
;      7: Readu, lun, var2, var3, var4, var5, var6, var7, _extra=_extra
;      8: Readu, lun, var2, var3, var4, var5, var6, var7, var8, _extra=_extra
;   endcase
