...
\item may \texttt{delayWeigh} be improved in processing speed and memory consumption?
\item commit \texttt{floatWeigh}, leave a message in \texttt{delayWeigh} to perform all changes in \texttt{floatWeigh} as well
