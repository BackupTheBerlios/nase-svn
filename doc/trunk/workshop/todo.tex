...
\begin{itemize}
  ...
  \item \texttt{basic_draw_widget}:
    ...
    \end{itemize}
  \item 
    Modify widgets to consisently use the new global font {\texttt!NASEWIDGETFONT}.
\end{itemize}
...
\item The /NASE keyword has inconsistent semantics: sometimes it
  ...
  and NSCALE, done, RK]
\item 
  In Windows, ExamineIt gives an error message {\texttt
    WIDGET_CONTROL: Microsoft Windows Error: font name too long.}
